...
name:"TypeScript",aliases:["ts","tsx"]}),b}})());hljs.registerLanguage("fortran",(()=>{"use strict";function e(...e){
...
},{className:"string",begin:/'/,end:/'/},n]}}})());hljs.registerLanguage("erlang-repl",(()=>{"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
...
relevance:0},{begin:"[A-Z][a-zA-Z0-9_']*",relevance:0}]})})());hljs.registerLanguage("shell",(()=>{"use strict";return s=>({
...
name:"Less",case_insensitive:!0,illegal:"[=>'/<($\"]",contains:c}}})());hljs.registerLanguage("mathematica",(()=>{"use strict"
...
begin:/[[\](){}]/}]}}})());hljs.registerLanguage("erlang",(()=>{"use strict";return e=>{
...
},contains:[c]}]}}})());hljs.registerLanguage("elm",(()=>{"use strict";return e=>{const n={
...
starts:{end:/^(?![ ]{6})/,subLanguage:"julia"},aliases:["jldoctest"]}]})})());hljs.registerLanguage("matlab",(()=>{"use strict";return e=>{var a={relevance:0,
...
begin:'""'}],starts:a
},e.COMMENT("^\\s*%\\{\\s*$","^\\s*%\\}\\s*$"),e.COMMENT("%","$")]}}})());hljs.registerLanguage("rust",(()=>{"use strict";return e=>{
...
preprocessor:l,strings:c,keywords:m}}}})());hljs.registerLanguage("latex",(()=>{"use strict";return e=>{const n=[{
...
end:/$/,keywords:{$pattern:/[\.\w]+/,"meta-keyword":".PHONY"}},r]}}})());hljs.registerLanguage("reasonml",(()=>{"use strict";return e=>{
...
begin:/\{/,end:/\}/,skip:!0}].concat(g)},v]}}})());hljs.registerLanguage("python",(()=>{"use strict";return e=>{const n={
...
className:"symbol",begin:/<[\w-]+>/}]})})());hljs.registerLanguage("glsl",(()=>{"use strict";return e=>({name:"GLSL",
keywords:{
...
className:"meta",begin:"#",end:"$"}]})})());hljs.registerLanguage("elixir",(()=>{"use strict";return e=>{
...
begin:"\\."+e.UNDERSCORE_IDENT_RE,relevance:0}]}}})());hljs.registerLanguage("haskell",(()=>{"use strict";return e=>{const n={
variants:[e.COMMENT("--","$"),e.COMMENT(/\{-/,/-\}/,{contains:["self"]})]},i={
